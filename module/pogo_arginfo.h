...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pogo_spawn, 0, 1, IS_LONG, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pogo_await, 0, 1, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, task, IS_LONG, 0)
...
ZEND_FUNCTION(pogo_spawn);
ZEND_FUNCTION(pogo_await);
ZEND_FUNCTION(pogo_pool_size);

static const zend_function_entry ext_functions[] = {
	ZEND_FE(pogo_spawn, arginfo_pogo_spawn)
